...
def run_a_board():
    print("=" * 60)
    print("AFAC2026 赛题四 - A 榜评测 V20")
    print("大重构: 题型×域分流 + 关键章节优先 + 防过选硬约束")
    ...
    qwen = QwenClient()
    agent = ReasoningAgentV20(qwen, doc_index, None, token_budget=TOKEN_BUDGET)
    ...
    # 备份
    import shutil
    v20_csv = os.path.join(RESULTS_DIR, "answer_v20.csv")
    shutil.copy(output_path, v20_csv)
    print(f"  备份 V20 → {v20_csv}")
