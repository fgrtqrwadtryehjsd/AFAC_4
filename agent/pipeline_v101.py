"""V10.1 流水线 — 逐选项检索+1次统一验证 (Token优化版)
...
from agent.reasoner_v101 import ReasoningAgentV101
...
def run_a_board():
    print("=" * 60)
    print("AFAC2026 赛题四 - A 榜评测 V10.1")
    print("逐选项检索 + 统一验证 (Token优化版)")
    print("V10: 4次独立验证=4.66M❌ → V10.1: 1次统一验证")
    ...
    qwen = QwenClient()
    agent = ReasoningAgentV101(qwen, doc_index, vector_indexer, token_budget=TOKEN_BUDGET)
