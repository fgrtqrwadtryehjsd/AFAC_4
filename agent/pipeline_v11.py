...
from agent.reasoner_v11 import ReasoningAgentV11
...
def run_a_board():
    print("=" * 60)
    print("AFAC2026 赛题四 - A 榜评测 V11")
    print("综合改进终极版")
    print("①②③④重标签+强制评分+Self-Critique增强")
    ...
    qwen = QwenClient()
    agent = ReasoningAgentV11(qwen, doc_index, vector_indexer, token_budget=TOKEN_BUDGET)

    print(f"\n🧠 开始推理 (①②③④重标签+强制评分+Self-Critique)...")
    print("=" * 60)
    ...
    print(f"  预估最终分数: 100 × Accuracy × (0.7 + 0.3 × {token_score:.4f})")
