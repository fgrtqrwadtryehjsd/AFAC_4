...
V10.1: A=59 (position bias回归) ❌
V10.2: 随机洗牌选项顺序 → 消除position bias ✅
"""
import os
import json
...
from agent.reasoner_v102 import ReasoningAgentV102
...
def run_a_board():
    print("=" * 60)
    print("AFAC2026 赛题四 - A 榜评测 V10.2")
    print("选项洗牌验证 (消除position bias)")
    print("V10.1: A=59 → V10.2: 选项随机洗牌 → A≈25")
    ...
    qwen = QwenClient()
    agent = ReasoningAgentV102(qwen, doc_index, vector_indexer, token_budget=TOKEN_BUDGET)
