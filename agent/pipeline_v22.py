...
def run_a_board():
    print("=" * 60)
    print("AFAC2026 V22 — V20 + fc + 财报锚词扩展")
    print("=" * 60)
    ...
    qwen = QwenClient()
    agent = ReasoningAgentV22(qwen, di, None, token_budget=TOKEN_BUDGET)
    ...
    import shutil
    v22_csv = os.path.join(RESULTS_DIR, "answer_v22.csv")
    shutil.copy(out, v22_csv)
    print(f"  备份 V22 → {v22_csv}")
